...
source_data = pd.read_csv(r'C:\Users\ynomu\Downloads\fl_Insurance_portfolio_raw_data.csv', index_col=None)
...
insurance_df.to_csv(r'C:\Users\ynomu\Downloads\fl_Insurance_portfolio_raw_data.csv', encoding='utf-8', index=False)
